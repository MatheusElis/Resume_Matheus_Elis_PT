...
2015-2021
:   **Bachelor's degree in Physics, with an emphasis on Computational
...
**Back-End Software Developer: GFT Technologies** - *Apr 2025 - Present*
...
* Creation and maintenance of ETL pipelines for financial data integration
  and reconciliation.
* Pipeline orchestration on Google Cloud Platform using Kubernetes (GKE) and
  Airflow Composer.
* Maintenance and management of SQL (PostgreSQL and MySQL) and NoSQL (MongoDB,
  Google Datastore and Redis) databases.
...
* Creation of microservices in cloud environments (Google Cloud Run, Google
  Cloud Functions and Google Kubernetes Engine).
* Data pipeline orchestration with Airflow Composer.
* Maintenance and management of SQL (PostgreSQL, MySQL and OracleDB) and NoSQL
  (MongoDB, Google Datastore and Redis) databases.
* Application monitoring using Grafana, Google Cloud Logging and Google Cloud
  Monitoring.
* Working under the Scrum agile methodology.


**Back-End Software Developer: ZAX** - *Mar 2022 - Sept 2022*
...
**Back-End Software Developer: TrackCash** - *June 2021 - Apr 2022*

Financial reconciliation company, serving sellers who sell their products on
...
* FastAPI, Flask, Django, Express, Gin, React, Bootstrap, Laravel, Magento
...
* Google Cloud Platform (Cloud Run, GKE, Cloud Functions, Datastore),
  AWS (Lambda, ECS, SQS, CloudWatch), Docker, Docker Compose, Kubernetes,
  Terraform
...
* Grafana, New Relic, Datadog, Google Cloud Logging, Google Cloud Monitoring
