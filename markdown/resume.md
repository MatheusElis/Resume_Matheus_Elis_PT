...
2015-2021
:   **Bacharel em Física, com ênfase em Física Computacional**; Universidade
    Federal Fluminense
...
* Manutenção e gerenciamento de bancos de dados SQL (PostgreSQL e MySQL) e
  NoSQL (MongoDB, Google Datastore e Redis).
...
* Criação e manutenção de pipelines de ETL para o setor de integração de
  dados.
* Criação de microsserviços em ambientes de nuvem (Google Cloud Run, Google
...
Marketplace de atacado para moda, com atuação no setor de Crédito e Risco.
...
Empresa de conciliação financeira, atendendo vendedores que comercializam
