...
\startitemize[packed]
\item
  Desenvolvimento e manutenção de aplicações Backend utilizando a
  liguagem Python e utilizando os frameworks FastAPI e Flask.
\item
  Desenvolvimento e manutenção de aplicações Backend utilizando a
  liguagem Golang e utilizando o framework Gin.
\item
...
\startitemize[packed]
\item
  Desenvolvimento e manutenção de aplicações Back-End utilizando a
  linguagem Python e utilizando os frameworks Django e FastAPI.
\item
  Desenvolvimento e manutenção de aplicações Back-End utilizando a
  linguagem NodeJS e utilizando o framework Express.
\item
