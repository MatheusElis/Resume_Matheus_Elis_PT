...
\item
  Criação de Microserviços em ambientes de Nuvem (Google Cloud Run e
...
\startitemize[packed]
\item
  Desenvolvimento e manutenção de aplicações Back-End usa GFT
  Technologiesndo a liguagem Python e os frameworks FastAPI e Flask.
\item
  Desenvolvimento e manutenção de aplicações Back-End usando a liguagem
